...
//            k_transz(x0, y0);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                //servo 1
                if ((tb_teta1.Text.Length > 0)&&(tb_teta2.Text.Length > 0)&&(tb_teta3.Text.Length > 0))
                {
                    i = float.Parse(tb_teta1.Text);
                    i = i + 90;
                    j = float.Parse(tb_teta2.Text);
                    j = j + 90;
                    k = float.Parse(tb_teta3.Text);
                    k = k + 90;
                    if ((i > 0) && (i < 170) && (j > 0) && (j < 170) && (k > 0) && (k < 170))
                        {
                            //jobb felso
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * k / 180))) }, 0, 1);//up
                            port.Write(new byte[] { Convert.ToByte(255 - Convert.ToInt32(Math.Round(255 * i / 180))) }, 0, 1);//middle
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * j / 180))) }, 0, 1);//low
                            for (c = 0; c < 100000; c++) ;
                                //jobb kozepso
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * k / 180))) }, 0, 1);//up
                            port.Write(new byte[] { Convert.ToByte(255 - Convert.ToInt32(Math.Round(255 * i / 180))) }, 0, 1);//middle
                            ...
                            //bal felso
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * k / 180))) }, 0, 1);
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * i / 180))) }, 0, 1);
                            port.Write(new byte[] { Convert.ToByte(255 - Convert.ToInt32(Math.Round(255 * j / 180))) }, 0, 1);
                            for (c = 0; c < 100000; c++) ;
                            //bal kozepso
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * k / 180))) }, 0, 1);
                            port.Write(new byte[] { Convert.ToByte(Convert.ToInt32(Math.Round(255 * i / 180))) }, 0, 1);
